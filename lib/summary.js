...
(async () => {
  if (cosmic_1.config("daily").includes("spotify")) await spotify_1.summary();
  ...
  if (cosmic_1.config("daily").includes("wakatime")) await wakatime_1.summary();
  if (cosmic_1.config("daily").includes("lastFm")) await last_fm_1.summary();
  if (cosmic_1.config("daily").includes("clockify")) await clockify_1.summary();
