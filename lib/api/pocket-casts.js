...
exports.daily = async () => {
    ...
    await common_1.write(path_1.join(".", "data", "podcasts", "library.json"), JSON.stringify(podcasts, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "podcasts", "history", year, month, `${day}.json`), JSON.stringify(newEpisodes, null, 2));
