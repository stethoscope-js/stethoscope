...
exports.daily = async () => {
    ...
    let items = [];
    try {
        const years = await fs_extra_1.readdir(path_1.join(".", "data", "podcasts", "pocket-casts", "history"));
    ...
    await common_1.write(path_1.join(".", "data", "podcasts", "pocket-casts", "history", year, month, `${day}.json`), JSON.stringify(newEpisodes, null, 2));
