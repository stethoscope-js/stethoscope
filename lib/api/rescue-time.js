...
const updateRescueTimeDailyData = async (date) => {
    ...
    await common_1.write(path_1.join(".", "data", "rescue-time", "daily", year, month, day, "top-categories.json"), JSON.stringify(topCategoriesData, null, 2));
    await common_1.write(path_1.join(".", "data", "rescue-time", "daily", year, month, day, "top-activities.json"), JSON.stringify(topActivitiesData, null, 2));
};
exports.daily = async () => {
