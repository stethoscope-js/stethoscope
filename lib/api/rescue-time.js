...
const updateRescueTimeDailyData = async (date) => {
    ...
    await fs_extra_1.ensureDir(path_1.join(".", "data", "rescue-time", "daily", year, month, day));
    await fs_extra_1.writeFile(path_1.join(".", "data", "rescue-time", "daily", year, month, day, "top-categories.json"), JSON.stringify(topCategoriesData, null, 2));
    await fs_extra_1.writeFile(path_1.join(".", "data", "rescue-time", "daily", year, month, day, "top-activities.json"), JSON.stringify(topActivitiesData, null, 2));
};
exports.daily = async () => {
