...
exports.getUserId = exports.daily = void 0;
...
const getTimeData = async (date) => {
    ...
    for await (const key of Object.keys(itemsByDate)) {
        await common_1.write(path_1.join(".", "data", "time-tracking", "clockify", "history", key, "time-entries.json"), JSON.stringify(itemsByDate[key], null, 2));
    }
