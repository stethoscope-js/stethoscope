...
exports.daily = async () => {
    ...
    for await (const key of Object.keys(itemsByDate)) {
        await common_1.write(path_1.join(".", "data", "music", "spotify", "daily", key, "listening-history.json"), JSON.stringify(itemsByDate[key], null, 2));
    }
    ...
    await common_1.write(path_1.join(".", "data", "music", "spotify", "daily", year, month, day, "library.json"), JSON.stringify(libraryItems, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-tracks", "short-term.json"), JSON.stringify(shortTermTopTracks, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-tracks", "medium-term.json"), JSON.stringify(mediumTermTopTracks, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-tracks", "long-term.json"), JSON.stringify(longTermTopTracks, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-artists", "short-term.json"), JSON.stringify(shortTermTopArtists, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-artists", "medium-term.json"), JSON.stringify(mediumTermTopArtists, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "daily", year, month, day, "top-artists", "long-term.json"), JSON.stringify(longTermTopArtists, null, 2));
