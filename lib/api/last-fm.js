...
const getLastFmTracks = async (date, page = 1) => {
    ...
    for await (const key of Object.keys(itemsByDate)) {
        await common_1.write(path_1.join(".", "data", "music", "last-fm", "history", key, "listening-history.json"), JSON.stringify(itemsByDate[key], null, 2));
    }
};
exports.daily = async () => {
    ...
    await common_1.write(path_1.join(".", "data", "music", "weekly", "top-albums", date.format("YYYY"), `${date.week()}.json`), JSON.stringify(topAlbumsWeekly.topalbums.album, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "weekly", "top-tracks", date.format("YYYY"), `${date.week()}.json`), JSON.stringify(topTracksWeekly.toptracks.track, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "weekly", "top-artists", date.format("YYYY"), `${date.week()}.json`), JSON.stringify(topArtistsWeekly.topartists.artist, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "monthly", "top-albums", date.format("YYYY"), `${date.format("MM")}.json`), JSON.stringify(topAlbumsMonthly.topalbums.album, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "monthly", "top-tracks", date.format("YYYY"), `${date.format("MM")}.json`), JSON.stringify(topTracksMonthly.toptracks.track, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "monthly", "top-artists", date.format("YYYY"), `${date.format("MM")}.json`), JSON.stringify(topArtistsMonthly.topartists.artist, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "yearly", "top-albums", `${date.format("YYYY")}.json`), JSON.stringify(topAlbumsYearly.topalbums.album, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "yearly", "top-tracks", `${date.format("YYYY")}.json`), JSON.stringify(topTracksYearly.toptracks.track, null, 2));
    ...
    await common_1.write(path_1.join(".", "data", "music", "yearly", "top-artists", `${date.format("YYYY")}.json`), JSON.stringify(topArtistsYearly.topartists.artist, null, 2));
